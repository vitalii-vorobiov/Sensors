...
static void LCD5110_refresh(LCD5110_display* lcd_conf)
{
...
static void LCD5110_clear_scr(LCD5110_display* lcd_conf){
	LCD5110_clrscr(&lcd_conf->hw_conf);
}
static void LCD5110_clear_win(LCD5110_canvas_t* win, LCD5110_display* lcd_conf){
	LCD5110_wrect_fill(&win->frame, WHITE, win, lcd_conf);
}
static void LCD5110_fill_scr(LCD5110_display* lcd_conf){
	LCD5110_fillscr(&lcd_conf->hw_conf);
}
static void LCD5110_fill_win(LCD5110_canvas_t* win, LCD5110_display* lcd_conf){
...
static void LCD5110_set_cursor(int x, int y, LCD5110_display* lcd_conf)
{
	LCD5110_wset_cursor(x, y, &lcd_conf->def_scr, lcd_conf);
}
static point_t LCD5110_get_cursor(LCD5110_display* lcd_conf)
{
...
static void LCD5110_line(int x1, int y1, int x2, int y2, int color, LCD5110_display* lcd_conf){
...
static void LCD5110_endl(LCD5110_display* lcd_conf) {
...
static void LCD5110_print(const char* str, int color, LCD5110_display* lcd_conf){
